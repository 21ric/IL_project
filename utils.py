...
def elaborate_noex(dict_file,no_ex, title):
    ...
    ax.plot(x, ft,label='fine tuning', markersize=2, linestyle='-o')
    ax.plot(x, lwf,label='LwF', markersize=2, linestyle='-o')
    ax.plot(x, icarl,label='iCaRL', markersize=2, linestyle='-o')
    ax.plot(x, noex,label='iCaRL no ex', markersize=2, linestyle='-o')
